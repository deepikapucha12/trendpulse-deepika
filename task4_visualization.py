...
plt.savefig("outputs/char1_top_stories.png")
plt.show()
...
plt.savefig("outputs/char2_categories.png")
plt.show()
...
plt.savefig("outputs/char3_scatter.png")
plt.show()
...
fig.savefig("TrendPulse Dashboard")
